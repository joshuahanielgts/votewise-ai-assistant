    ...
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        <Link to="/" className="flex items-center gap-2 group" aria-label="VoteWise home">
          <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-hero text-primary-foreground shadow-soft group-hover:scale-105 transition-transform overflow-hidden">
        ...
        <nav className="flex items-center gap-5">
          <Link to="/chat" className={linkCls} activeProps={{ className: "hidden text-sm font-semibold text-foreground sm:inline" }}>
            Ask AI
          </Link>
